...
To analyze their co-occurrence  we need to call `cooccurrence` and specify the `field` (column in the data) and the separator (`sep`) that separates the values that co-occur, within the same field.
